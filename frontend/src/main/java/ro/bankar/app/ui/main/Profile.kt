...
fun Profile(onDismiss: () -> Unit) {
    ...
    PopupScreen(onDismiss, title = R.string.profile) {
        Column(modifier = Modifier
            .verticalScroll(rememberScrollState())
            .padding(12.dp)) {

            Row(
                horizontalArrangement = Arrangement.spacedBy(30.dp), modifier = Modifier
                    .fillMaxWidth()
                    .padding(vertical = 5.dp)
            ) {
                Box {
                    Icon(
                        Icons.Default.AccountCircle, stringResource(R.string.account), modifier = Modifier
            ...
            FilledIconButton(
                ...
                Icon(
                    Icons.Default.Create, stringResource(R.string.account), modifier = Modifier
                        .size(65.dp)
                )
            }
        }
